...
public class SSPurchaseManager: NSObject {
    public static let shared = SSPurchaseManager()
    ...
    override init() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(SSPurchaseManager.savePurchasedItems), name: NSNotification.Name.UIApplicationDidEnterBackground, object: nil)
    }
...
extension SSPurchaseManager: SKProductsRequestDelegate {
...
extension SSPurchaseManager: SKPaymentTransactionObserver {
...
extension SSPurchaseManager { // Store file managment
